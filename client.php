...
// 埋め込み文字列を置換する
$js = str_replace(array("<!--[ofxhead]-->", "\"<!--[filist]-->\"", "\"<!--[debug]-->\""), array($ofxhead, $filist, (ENV_BOOL_DEBUG == true? "true": "false")), file_get_contents(ENV_FILE_DIR_CLIENT . ENV_FILE_TEMPLATE_JS));
